        ...
        http
                ...
                .authorizeHttpRequests(authorize ->
                        authorize
                                ...
                                .requestMatchers("/api/join", "/api/signin", "/api/token", "/api/hello", "/api/mailSend", "/api/mailauthCheck", "/", "/h2-console/**", "/front4/public/**", "/api/checkUserId", "/api/newPw", "/api/newPwUpdate","api/kakao/login").permitAll()
